![Logo](https://github.com/sclemson/Shipwrecked/blob/main/client/src/images/Logo-removebg-preview%20cropped.png)
...
## Bugs
_Shipwrecked_ is completely playable and for those bugs that we did find, we were able to find solutions. Throughout the testing process we adopted a policy of trying to solve an issue first and foremost and then, if this was not possible quickly enough, adapting the narrative. This approach served us well and, as a result, the finished version runs as intended.
